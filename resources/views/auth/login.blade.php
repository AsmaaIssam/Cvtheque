                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ml-1">ETAFAT</h2>
                                </a>

                                {{-- <h4 class="card-title mb-1">Welcome to Etafat!</h4> --}}
                                <p class="card-text mb-2">Connectez-vous à votre compte</p>

                                <form class="auth-login-form mt-2" action=" {{route('login')}} " method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label for="email" class="form-label">Adresse e-mail</label>
                                        <input type="text" class="form-control" id="email" name="email" placeholder="user@example.com" aria-describedby="login-email" tabindex="1" autofocus />
                                    </div>
                                    ...
                                    <button class="btn btn-primary btn-block" tabindex="4">{{ __('Se connecter') }}</button>
                                </form>
