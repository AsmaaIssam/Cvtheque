          ...
          <div class="row">
            <div class="col-md-6 col-12">
              <div class="form-group">
                ...
                <input id="name" name="name"  type="text" id="name" class="form-control" placeholder="Nom" >
              </div>
            </div>
            <div class="col-md-6 col-12">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="form-label-group">
                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Label in Textarea"></textarea>
                        <label for="label-textarea">description du role</label>
                      </div>
                    </div>
                  </div>
                </div>
